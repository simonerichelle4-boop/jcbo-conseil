  ...
  <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 20px' }}>
    ...
    <div style={{
      ...
      >
        ...
        <Link 
          to="/expertises#coaching-strategique"
          style={{ color: '#C9A445', fontWeight: '600', textDecoration: 'none' }}
        >
          Découvrir →
        </Link>
      </div>
      ...
      >
        ...
        <Link 
          to="/expertises#coaching-en-ligne"
          style={{ color: '#C9A445', fontWeight: '600', textDecoration: 'none' }}
        >
          Découvrir →
        </Link>
      ...
      {/* 3. Formation / Séminaire en groupes */}
      <div style={{
        backgroundColor: 'white',
        padding: '45px 30px',
        borderRadius: '12px',
      ...
      >
        ...
        <Link 
          to="/expertises#seminaire-groupes"
          style={{ color: '#C9A445', fontWeight: '600', textDecoration: 'none' }}
        >
          Découvrir →
        </Link>
        ...
        <div style={styles.container}>
          <div style={styles.aproposGrid}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.15rem', lineHeight: '1.7', marginBottom: '30px' }}>
